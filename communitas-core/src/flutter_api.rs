...
//! Flutter FFI API surface via flutter_rust_bridge
...
/// Opaque API wrapper exposed to Flutter
#[allow(unexpected_cfgs)]
#[frb(opaque)]
#[derive(Clone)]
...
impl CommunitasApi {
    ...
    pub async fn auth_get_current_session(&self) -> Result<Option<FlutterSessionInfo>, String> {
        let auth = self.auth.read().await;
        Ok(auth.get_current_session().map(FlutterSessionInfo::from))
    }

    pub async fn auth_list_vaults(&self) -> Result<Vec<FlutterVaultInfo>, String> {
        let auth = self.auth.read().await;
        let vaults = auth.list_vaults().await.map_err(|e| e.to_string())?;
        Ok(vaults.into_iter().map(FlutterVaultInfo::from).collect())
    }
    ...
    pub async fn auth_login(
        ...
        four_words: String,
        password: String,
    ) -> Result<FlutterSessionInfo, String> {
        let mut auth = self.auth.write().await;
    ...
    pub async fn get_profile(&self) -> Result<FlutterUserProfile, String> {
    ...
    pub async fn update_display_name(
        &self,
        display_name: String,
    ) -> Result<Vec<FlutterEvent>, String> {
    ...
    pub async fn gossip_start(&self, port: Option<u16>) -> Result<Vec<FlutterEvent>, String> {
        execute_command(
            &self.app,
    ...
    pub async fn gossip_stop(&self) -> Result<Vec<FlutterEvent>, String> {
        execute_command(&self.app, Command::StopNetworking).await
    }

    pub async fn gossip_connect_to_peer(
        &self,
        four_words: String,
    ) -> Result<Vec<FlutterEvent>, String> {
        execute_command(
    ...
    pub async fn gossip_get_network_info(&self) -> Result<FlutterNetworkInfo, String> {
    ...
    pub async fn entity_list(&self) -> Result<Vec<FlutterEntity>, String> {
        match execute_query(&self.app, Query::ListEntities).await? {
            QueryResponse::EntityList(entities) => {
                Ok(entities.into_iter().map(FlutterEntity::from).collect())
            }
    ...
    ) -> Result<Vec<FlutterEntity>, String> {
        match execute_query(
            &self.app,
    ...
    pub async fn entity_get(&self, entity_id: String) -> Result<FlutterEntity, String> {
    ...
    pub async fn entity_create(
        ...
        if let Some(parent_org_id) = parent_org_id {
            if let Some(entity_id) = events.iter().find_map(|event| match event {
                FlutterEvent::EntityCreated { entity_id } => Some(entity_id.clone()),
                _ => None,
            }) {
    ...
    pub async fn message_list(&self, entity_id: String) -> Result<Vec<FlutterMessage>, String> {
        match execute_query(&self.app, Query::GetEntityMessages { entity_id }).await? {
            QueryResponse::Messages(messages) => {
                Ok(messages.into_iter().map(FlutterMessage::from).collect())
            }
    ...
    ) -> Result<Vec<FlutterMessage>, String> {
        match execute_query(
            &self.app,
    ...
    pub async fn contacts_list(&self) -> Result<Vec<FlutterContact>, String> {
        match execute_query(&self.app, Query::ListContacts).await? {
            QueryResponse::ContactList(contacts) => {
                Ok(contacts.into_iter().map(FlutterContact::from).collect())
            }
            _ => Err("Unexpected response for ListContacts".to_string()),
        }
    }

    pub async fn contact_get(&self, contact_id: String) -> Result<FlutterContact, String> {
    ...
    pub async fn contacts_list_favourites(&self) -> Result<Vec<FlutterContact>, String> {
    ...
    pub async fn contacts_search(&self, query: String) -> Result<Vec<FlutterContact>, String> {
    ...
    pub async fn contact_delete(&self, contact_id: String) -> Result<Vec<FlutterEvent>, String> {
    ...
    pub async fn contact_set_favourite(
        &self,
        four_words: String,
    ) -> Result<Vec<FlutterEvent>, String> {
    ...
    pub async fn presence_announce(&self) -> Result<Vec<FlutterEvent>, String> {
        execute_command(&self.app, Command::AnnouncePresence).await
    }

    pub async fn presence_get_our_record(&self) -> Result<Option<FlutterPresenceRecord>, String> {
        match execute_query(&self.app, Query::GetOurPresenceRecord).await? {
            QueryResponse::OurPresenceRecord(record) => Ok(record.map(FlutterPresenceRecord::from)),
            _ => Err("Unexpected response for GetOurPresenceRecord".to_string()),
        }
    }

    pub async fn presence_get_status(
        &self,
        peer_id: String,
    ) -> Result<FlutterPresenceStatus, String> {
        match execute_query(&self.app, Query::GetPresence { peer_id }).await? {
            QueryResponse::Presence(presence) => Ok(FlutterPresenceStatus::from(presence)),
    ...
    pub async fn presence_get_cached_peer(
        &self,
        pubkey_hex: String,
    ) -> Result<Option<FlutterPresenceRecord>, String> {
        ...
        match execute_query(&self.app, Query::GetCachedPeerPresence { pubkey: bytes }).await? {
            QueryResponse::CachedPeerPresence(record) => {
                Ok(record.map(FlutterPresenceRecord::from))
            }
    ...
    pub async fn invite_accept(&self, invite_id: String) -> Result<Vec<FlutterEvent>, String> {
        execute_command(&self.app, Command::AcceptInvite { invite_id }).await
    }

    pub async fn invite_reject(&self, invite_id: String) -> Result<Vec<FlutterEvent>, String> {
        execute_command(&self.app, Command::RejectInvite { invite_id }).await
    }

    pub async fn invite_revoke(&self, invite_id: String) -> Result<Vec<FlutterEvent>, String> {
    ...
    pub async fn disk_list_files(
        &self,
        entity_id: String,
        disk_type: FlutterDiskType,
        path: String,
    ) -> Result<Vec<FlutterFileInfo>, String> {
        match execute_query(
            &self.app,
            Query::ListFiles {
                entity_id,
        ...
        .await?
        {
            QueryResponse::FileList(files) => {
                Ok(files.into_iter().map(FlutterFileInfo::from).collect())
            }
    ...
    pub async fn disk_get_stats(
        ...
        entity_id: String,
        disk_type: FlutterDiskType,
    ) -> Result<FlutterDiskStats, String> {
        match execute_query(
            &self.app,
            Query::GetDiskStats {
                entity_id,
    ...
    pub async fn kanban_list_boards(
        &self,
        entity_id: String,
    ) -> Result<Vec<FlutterKanbanBoard>, String> {
        match execute_query(&self.app, Query::ListKanbanBoards { entity_id }).await? {
            QueryResponse::KanbanBoardList(boards) => {
                Ok(boards.into_iter().map(FlutterKanbanBoard::from).collect())
            }
            _ => Err("Unexpected response for ListKanbanBoards".to_string()),
        }
    }

    pub async fn kanban_get_board(&self, board_id: String) -> Result<FlutterKanbanBoard, String> {
    ...
    pub async fn kanban_create_board(
        ...
        board_name: String,
        description: Option<String>,
    ) -> Result<FlutterKanbanBoard, String> {
    ...
    pub async fn kanban_create_column(
        ...
        column_name: String,
        position: Option<u32>,
    ) -> Result<FlutterKanbanColumn, String> {
        let events = execute_command_raw(
            &self.app,
    ...
    pub async fn kanban_list_cards(
    ...
    ) -> Result<Vec<FlutterKanbanCard>, String> {
        match execute_query(
            &self.app,
        ...
        .await?
        {
            QueryResponse::KanbanCards(cards) => {
                Ok(cards.into_iter().map(FlutterKanbanCard::from).collect())
            }
    ...
    ) -> Result<FlutterKanbanCard, String> {
        let events = execute_command_raw(
            &self.app,
...
pub fn preview_identity_from_mnemonic(
...
) -> Result<FlutterRecoveredIdentity, String> {
    ...
    Ok(FlutterRecoveredIdentity::from(keys))
}
...
impl From<FlutterDiskType> for DiskTypeArg {
    fn from(value: FlutterDiskType) -> Self {
        match value {
            FlutterDiskType::Private => DiskTypeArg::Private,
            FlutterDiskType::Public => DiskTypeArg::Public,
            FlutterDiskType::Shared => DiskTypeArg::Shared,
        }
    }
}

impl From<DiskTypeArg> for FlutterDiskType {
    fn from(value: DiskTypeArg) -> Self {
        match value {
            DiskTypeArg::Private => FlutterDiskType::Private,
            DiskTypeArg::Public => FlutterDiskType::Public,
            DiskTypeArg::Shared => FlutterDiskType::Shared,
        }
    }
}

impl From<FlutterEntityType> for EntityType {
    fn from(value: FlutterEntityType) -> Self {
        match value {
...
/// Event type for Flutter callbacks
#[derive(Debug, Clone)]
...
#[derive(Debug, Clone)]
pub struct FlutterRecoveredIdentity {
    pub four_words: String,
    pub pubkey_hex: String,
}

impl From<crate::recovery::IdentityKeys> for FlutterRecoveredIdentity {
...
pub struct FlutterMessage {
    ...
    pub reactions: Vec<FlutterReaction>,
    pub edited_at: Option<u64>,
}

impl From<MessageResponse> for FlutterMessage {
...
impl From<ReactionResponse> for FlutterReaction {
...
impl From<ContactResponse> for FlutterContact {
...
impl From<FileInfoResponse> for FlutterFileInfo {
...
#[derive(Debug, Clone)]
pub struct FlutterDiskStats {
    pub entity_id: String,
    pub disk_type: FlutterDiskType,
    pub used_bytes: u64,
    pub file_count: u32,
    pub dir_count: u32,
}

impl From<DiskStatsResponse> for FlutterDiskStats {
...
impl From<KanbanBoardResponse> for FlutterKanbanBoard {
...
#[derive(Debug, Clone)]
pub struct FlutterKanbanColumn {
    pub id: String,
    pub board_id: String,
    pub name: String,
    pub position: u32,
...
impl From<KanbanColumnResponse> for FlutterKanbanColumn {
...
impl From<KanbanCardResponse> for FlutterKanbanCard {
...
#[derive(Debug, Clone)]
pub struct FlutterPresenceRecord {
    pub pubkey_hex: String,
...
impl From<PresenceRecord> for FlutterPresenceRecord {
...
#[derive(Debug, Clone)]
pub struct FlutterPresenceStatus {
    pub peer_id: String,
    pub status: String,
    pub last_seen: i64,
}

impl From<PresenceResponse> for FlutterPresenceStatus {
...
fn map_event(event: Event) -> Option<FlutterEvent> {
    match event {
        Event::NetworkingStarted {
            listen_address,
            connection_identity,
        } => Some(FlutterEvent::NetworkingStarted {
        ...
        Event::NetworkingStopped => Some(FlutterEvent::NetworkingStopped),
        Event::PeerConnected { peer_four_words } => Some(FlutterEvent::PeerConnected {
            peer_id: peer_four_words,
        }),
        Event::ConnectionFailed { reason, .. } => Some(FlutterEvent::Error {
            code: "CONNECTION_FAILED".to_string(),
            message: reason,
        }),
        Event::EntityCreated { entity_id, .. } => Some(FlutterEvent::EntityCreated { entity_id }),
        Event::EntityUpdated { entity_id, .. } => Some(FlutterEvent::EntityUpdated { entity_id }),
        Event::MessageSent {
            message_id,
            entity_id,
            ..
        } => Some(FlutterEvent::MessageSent {
            message_id,
            entity_id,
        }),
        Event::MessageReceived {
            ...
            entity_id,
            ..
        } => Some(FlutterEvent::MessageReceived {
            message_id,
            entity_id,
        }),
        Event::DirectMessageSent {
            message_ids,
            recipients,
        } => Some(FlutterEvent::DirectMessageSent {
            message_ids,
            recipients,
        }),
        Event::MessageDeleted {
            ...
            entity_id,
            ..
        } => Some(FlutterEvent::MessageDeleted {
            message_id,
            entity_id,
        }),
        Event::MessageEdited {
            ...
            edited_at,
            ..
        } => Some(FlutterEvent::MessageEdited {
            message_id,
            entity_id,
            new_text,
            edited_at,
        ...
        Event::ReactionAdded {
            ...
            reactor_id,
            ..
        } => Some(FlutterEvent::ReactionAdded {
            message_id,
            entity_id,
            emoji,
            reactor_id,
        ...
        Event::ReactionRemoved {
            ...
            reactor_id,
            ..
        } => Some(FlutterEvent::ReactionRemoved {
            message_id,
            entity_id,
            emoji,
            reactor_id,
        }),
        Event::InviteCreated { invite_id, .. } => Some(FlutterEvent::InviteCreated { invite_id }),
        Event::InviteAccepted { invite_id, .. } => Some(FlutterEvent::InviteAccepted { invite_id }),
        Event::InviteRejected { invite_id } => Some(FlutterEvent::InviteRejected { invite_id }),
        Event::InviteRevoked { invite_id } => Some(FlutterEvent::InviteRevoked { invite_id }),
        Event::FileWritten {
            entity_id, path, ..
        } => Some(FlutterEvent::FileWritten { entity_id, path }),
        Event::FileDeleted {
            entity_id, path, ..
        } => Some(FlutterEvent::FileDeleted { entity_id, path }),
        _ => None,
    }
}
