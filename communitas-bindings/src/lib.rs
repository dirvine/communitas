...
pub mod flutter_api;
// frb_generated is auto-generated by flutter_rust_bridge and contains unwrap() calls
// that are inherent to the code generator. These are safe as they handle serialization
// of known valid data.
#[cfg(feature = "flutter-bindings")]
