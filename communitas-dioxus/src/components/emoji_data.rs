...
pub static ALL_EMOJIS: &[EmojiEntry] = &[
    ...
    EmojiEntry {
        emoji: "🤗",
        name: "smiling face with open hands hugging",
        category: EmojiCategory::Smileys,
    },
    EmojiEntry {
        emoji: "🤭",
    ...
    EmojiEntry {
        emoji: "🍜",
        name: "steaming bowl noodles ramen",
        category: EmojiCategory::Food,
    },
    EmojiEntry {
        emoji: "🍣",
    ...
    EmojiEntry {
        emoji: "🚛",
        name: "articulated lorry semi truck",
        category: EmojiCategory::Travel,
    },
    EmojiEntry {
        emoji: "🚜",
    ...
    EmojiEntry {
        emoji: "🎉",
        name: "party popper celebration",
        category: EmojiCategory::Symbols,
    },
    EmojiEntry {
        emoji: "🎊",
        name: "confetti ball celebration",
        category: EmojiCategory::Symbols,
    },
    EmojiEntry {
        emoji: "🏆",
        name: "trophy award winner",
        category: EmojiCategory::Symbols,
    },
    EmojiEntry {
        emoji: "🥇",
        name: "first place gold medal",
        category: EmojiCategory::Symbols,
    },
    EmojiEntry {
        emoji: "✅",
    ...
    EmojiEntry {
        emoji: "🇺🇸",
        name: "united states flag us america",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇬🇧",
        name: "united kingdom flag uk britain",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇨🇦",
        name: "canada flag canadian",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇦🇺",
        name: "australia flag australian",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇩🇪",
        name: "germany flag german",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇫🇷",
        name: "france flag french",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇯🇵",
        name: "japan flag japanese",
        category: EmojiCategory::Flags,
    },
    EmojiEntry {
        emoji: "🇰🇷",
        name: "south korea flag korean",
        category: EmojiCategory::Flags,
    },
];
...
mod tests {
    ...
    fn search_smile_finds_smile_related() {
        ...
        for entry in &results {
            assert!(
                entry.name.contains("smiling"),
                "Expected 'smiling' in name: {}",
                entry.name
            );
        }
    }
