import {
    CallEnd as CallEndIcon, Chat as ChatIcon, Close as CloseIcon, DragHandle as DragHandleIcon,
    FiberManualRecord as FiberManualRecordIcon, Fullscreen as FullscreenIcon,
    FullscreenExit as FullscreenExitIcon, Mic as MicIcon,
    MicOff as MicOffIcon, Minimize as MinimizeIcon, MoreVert as MoreVertIcon, OpenInFull as MaximizeIcon, People as PeopleIcon,
    PersonAdd as PersonAddIcon, Phone as PhoneIcon, PictureInPicture as PipIcon, ScreenShare as ScreenShareIcon, Send as SendIcon, Settings as SettingsIcon, Stop as StopIcon, StopScreenShare as StopScreenShareIcon, VideoCall as VideoCallIcon, Videocam as VideocamIcon,
    VideocamOff as VideocamOffIcon
} from '@mui/icons-material';
import {
    Avatar,
    AvatarGroup, Badge, Box, Button, Chip, Dialog, DialogActions, DialogContent, DialogTitle, Grid, IconButton, List,
