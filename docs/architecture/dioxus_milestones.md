...
| **1 — Foundations (Nav shell + Auth)** | Scaffold `communitas-dioxus`, wire `communitas-ui-service`, deliver router/nav shell, login/create/recover, desktop bundles + installer smoke. | ⏳ Near complete (7/8 gates passing, target Feb 7, 2026) | 7/8 validation gates passing: shared services ✅, directory wiring ✅, Dioxus components ✅, router guarding ✅, MCP parity ✅, accessibility ✅, telemetry ✅. Remaining: installer smoke (Linux only). |
